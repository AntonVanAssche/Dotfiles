...
case ${wallpaper} in
   ...
   5| "Keyboards") Execute "gsettings set org.gnome.desktop.background picture-uri ${wallpaperDir}/Keyboards.jpg" "Setting wallpaper 'Keyboards'";;
   6| "Selena Gomez") Execute "gsettings set org.gnome.desktop.background picture-uri ${wallpaperDir}/Selena-Gomez.jpg" "Setting wallpaper 'Selena Gomez'";;
   7| "Tate McRae") Execute "gsettings set org.gnome.desktop.background picture-uri ${wallpaperDir}/Tate-McRae.jpg" "Setting wallpaper 'Tate McRae'";;
   8| "Emma Watson") Execute "gsettings set org.gnome.desktop.background picture-uri ${wallpaperDir}/Emma-Watson.jpg" "Setting wallpaper 'Emma Watson'";;
esac
