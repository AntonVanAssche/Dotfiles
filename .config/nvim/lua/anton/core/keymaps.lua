...
keymap.set('n', '<C-d>', '<C-d>zz',                                                  { desc = "Keep cursor in the middle of the screen when moving half a page up or down", silent = true })
keymap.set('n', '<C-u>', '<C-u>zz',                                                  { desc = "Keep cursor in the middle of the screen when moving half a page up or down", silent = true })
...
keymap.set({'n', 'v'}, '<leader>d', [["_d]],                                         { desc = "Delete everything behind the cursor until the end of the line", silent = true })
keymap.set('n', '<leader>cs', ':setlocal spell! spelllang=en_us,nl<CR>',             { desc = "Toggle spellchecker" , silent = true})
keymap.set('n', '<leader>sc', ':!clear && shellcheck %s<CR>',                        { desc = "Shellcheck" , silent = true})
keymap.set('n', '<leader>cc', ':lua SCC()<CR>',                                      { desc = "Toggle colorcolumn" , silent = true})
...
keymap.set('n', '<leader>s', [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/gI<Left><Left><Left>]], { desc = "Search and replace word under cursor", silent = true })
...
keymap.set("n", "se", "<C-w>=",                                                      { desc = "Make splits equal size", silent = true })
keymap.set("n", "sx", "<cmd>close<CR>",                                              { desc = "Close current split", silent = true })
